...
#endif
#if defined(GST_IOS_PLUGIN_SWITCHBIN) || defined(GST_IOS_PLUGINS_CORE)
...
#endif
#if defined(GST_IOS_PLUGIN_ADAPTIVEDEMUX2) || defined(GST_IOS_PLUGINS_CODECS)
...
#endif
#if defined(GST_IOS_PLUGIN_AMRNB) || defined(GST_IOS_PLUGINS_CODECS)
GST_PLUGIN_STATIC_DECLARE(amrnb);
#endif
#if defined(GST_IOS_PLUGIN_AMRWBDEC) || defined(GST_IOS_PLUGINS_CODECS)
...
#endif
#if defined(GST_IOS_PLUGIN_XINGMUX) || defined(GST_IOS_PLUGINS_CODECS)
...
#endif
#if defined(GST_IOS_PLUGIN_CODECALPHA) || defined(GST_IOS_PLUGINS_CODECS)
GST_PLUGIN_STATIC_DECLARE(codecalpha);
#endif
#if defined(GST_IOS_PLUGIN_CODECTIMESTAMPER) || defined(GST_IOS_PLUGINS_CODECS)
...
#endif
#if defined(GST_IOS_PLUGIN_DVBSUBENC) || defined(GST_IOS_PLUGINS_CODECS)
...
#endif
#if defined(GST_IOS_PLUGIN_RTPONVIF) || defined(GST_IOS_PLUGINS_NET)
...
#endif
#if defined(GST_IOS_PLUGIN_AES) || defined(GST_IOS_PLUGINS_EFFECTS)
...
#endif
#if defined(GST_IOS_PLUGIN_ISAC) || defined(GST_IOS_PLUGINS_EFFECTS)
GST_PLUGIN_STATIC_DECLARE(isac);
#endif
...
#endif
#if defined(GST_IOS_PLUGIN_ENGINE) || defined(GST_IOS_PLUGINS_STUDIO)
GST_PLUGIN_STATIC_DECLARE(engine);
#endif
#if defined(GST_IOS_PLUGIN_PREVIEW) || defined(GST_IOS_PLUGINS_STUDIO)
GST_PLUGIN_STATIC_DECLARE(preview);
#endif
#if defined(GST_IOS_PLUGIN_PUBLISH) || defined(GST_IOS_PLUGINS_STUDIO)
...
#endif
#if defined(GST_IOS_PLUGIN_ISAC) || defined(GST_IOS_PLUGINS_EFFECTS)
    GST_PLUGIN_STATIC_REGISTER(isac);
#endif
#if defined(GST_IOS_PLUGIN_IVTC) || defined(GST_IOS_PLUGINS_EFFECTS)
